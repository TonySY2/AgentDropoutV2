...
INPUT_DATASET="project_datasets/livecode/livecodebench_v1.jsonl"
...
output_dir=results-livecode/debug-1
tmp_dir=${output_dir}/tmp_livecode
...
echo "Starting LiveCodeBench MAS job with ${node_num} nodes..."
...
for ((i=0; i<$node_num; i++)); do
    ...
    SCRIPT_PATH="experiments/livecode/run_livecode.py"
