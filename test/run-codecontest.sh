...
INPUT_DATASET="project_datasets/codecontest/test.jsonl"
...
output_dir=results-codecontest/autogen-base
tmp_dir=${output_dir}/tmp_codecontest
...
echo "Starting CodeContest MAS job with ${node_num} nodes..."
...
for ((i=0; i<$node_num; i++)); do
    ...
    SCRIPT_PATH="experiments/codecontest/run_codecontest.py"
